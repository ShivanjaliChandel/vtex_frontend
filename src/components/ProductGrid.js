    ...
    useEffect(() => {
        const fetchCollectionProducts = async () => {
            try {
                ...
                const collectionResponse = await axios.get(`https://vtex-backend-94ev.onrender.com/collectionProduct?collectionId=${collectionId}`);
                    ...
                    const productsWithPrices = await Promise.all(
                        products.map(async (product) => {
                            try {
                                ...
                                const priceResponse = await axios.get(`https://vtex-backend-94ev.onrender.com/pricing/${product.SkuId}`);
...
//                     // `https://vtex-backend-94ev.onrender.com/collectionProduct?collectionId=${collectionId}`
//                 );
//                 if (Array.isArray(collectionResponse.data.Data)) {
//                     const products = collectionResponse.data.Data;
...
//                                     // `https://vtex-backend-94ev.onrender.com/pricing/${product.SkuId}`
